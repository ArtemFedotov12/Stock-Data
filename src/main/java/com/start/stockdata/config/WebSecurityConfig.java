 ...
 /*   @Bean
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers("/hello8").permitAll()
                .antMatchers("/hello9").permitAll()
                .antMatchers("/hello10").permitAll()
                .antMatchers("/hello11").permitAll()
                .antMatchers("/hello12").permitAll()
                .antMatchers("/hello13").permitAll()
                .antMatchers("/hello14").permitAll()
                .antMatchers("/hello15").permitAll()
                .antMatchers("/hello16").permitAll()
                .antMatchers("/hello17").permitAll()
