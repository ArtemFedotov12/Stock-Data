...
public enum StockExceptionType {
    ...
    USER_DOES_NOT_HAVE_ANY_COMPANY("STOCK-005", BAD_REQUEST),
    ...
    DELETE_ALL_NOT_FOUND_ENTITY("STOCK-012", BAD_REQUEST),
    SAVE_FIELD("STOCK-013", INTERNAL_SERVER_ERROR),
    FIELD_ALREADY_EXISTS_WITHIN_THE_COMPANY("STOCK-014", BAD_REQUEST),
    INTERNAL_STOCK_EXCEPTION("STOCK-015", INTERNAL_SERVER_ERROR),
